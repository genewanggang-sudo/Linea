...
(function (f) {
    ...
    (function (console, $hx_exports, $global) {
        ...
        verb_eval_Make.loftedSurface = function (curves, degreeV, dontUnifyCurve) {
            if (!dontUnifyCurve) {
        ...
        verb_eval_Make.extrudedSurface = function (axis, length, profile) {
            ...
            while (_g1 < _g) {
                var j = _g1++;
                controlPoints[1][j] = prof_controlPoints[j];
        ...
        */
        ...
        verb,
        [window, globalThis, global, this].find(_ => typeof _ != 'undefined')
    );
