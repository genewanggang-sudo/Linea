...
describe('Arc2', () => {
    ...
    it('evaluates clockwise and counter-clockwise arcs', () => {
        ...
        expect(ccw.getStartPt().equals(new Vec2(1, 0), 1e-9)).toBe(true)
        expect(ccw.getEndPt().equals(new Vec2(0, 1), 1e-9)).toBe(true)
        ...
        expect(cw.getStartPt().equals(new Vec2(1, 0), 1e-9)).toBe(true)
        expect(cw.getEndPt().equals(new Vec2(0, -1), 1e-9)).toBe(true)
    ...
    it('closestPoint and strict range behavior', () => {
        ...
        expect(arc.containsPt(arc.getMidPt())).toBe(true)
