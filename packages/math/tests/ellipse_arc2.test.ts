...
describe('EllipseArc2', () => {
    it('handles clockwise and counter-clockwise mapping', () => {
        ...
        expect(ccw.getStartPt().equals(new Vec2(4, 0), 1e-9)).toBe(true)
        expect(ccw.getEndPt().equals(new Vec2(0, 2), 1e-9)).toBe(true)
        ...
        expect(cw.getEndPt().equals(new Vec2(0, -2), 1e-9)).toBe(true)
